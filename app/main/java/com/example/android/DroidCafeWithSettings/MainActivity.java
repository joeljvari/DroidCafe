 ...
 * showing which food item was chosen and add it to the cart.
 * cart contain  all the items that is choosen by the user,
 * In cart user can add the no of items , user can proceed and remove the items that user added,
 * When user proceeds,This activity lets the user choose a delivery method using radio buttons,
 * and displays a Toast message showing the choice. This app is a demo of
 * the options menu, clickable images, and radio buttons.
 *shop can add status.
 * it can also view the fav.
